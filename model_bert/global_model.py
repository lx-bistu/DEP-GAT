...
from model_bert.gat import WSWGAT
...
class ConvEncoder(nn.Module):
    ...
    def forward(self, graph, batch, local_feature):
        ...
        self.set_sentNode_feature_bert(graph, batch, local_feature)
    ...
    def set_sentNode_feature_bert(self, graph, batch, local_feature):
        sent_feature = local_feature
        ...
        graph.nodes[snode_id].data['init_state'] = sent_feature

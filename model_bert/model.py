...
from model_bert.global_model import ConvEncoder
from model_bert.bert_model import bert_UtterEncoder
...
class Graph_DialogRe(nn.Module):
    ...
    def __init__(self, config, vocab):
        ...
        self.local_model = bert_UtterEncoder(config, vocab)
    ...
    def forward(self, batch):
        ...
        local_feature = self.local_model(batch)
